...
def output_handler(_rhythmo_inputs, rhythmo_outputs, parameters) -> None:
    ...
    projection_duration = 4 * strongest_peak if projection_duration == 'None' else projection_duration #how long to project cycle in days
    ...
    fig.add_trace(go.Scatter(x = time_in_future[:projection_duration], 
                            y = projected_cycle[:projection_duration], 
